...
(function (M, Y, t) {
    ...
    function Ed(b, a, c) {
        for (var d = Object.keys(b)
                .sort(), e = 0; e < d.length; e++) a.call(c
            , b[d[e]], d[e]);
        return d
    }
    ...
    function Ea(b, a, c, d) {
        ...
        if (a) {
            ...
            if (x(b))
                for (var f = a.length = 0; f < b.length; f++) e = Ea(b[f], null, c, d), P(b[f]) && (c.push(b[f]), d.push(e)), a.push(e);
            else {
                var g = a.$$hashKey;
                x(a) ? a.length =
                    0 : s(a, function (b, c) {
        ...
        } else if (a = b) x(b) ? a = Ea(b, [], c, d) : pa(b) ? a = new Date(b.getTime()) : ob(b) ? (a = new RegExp(b.source, b.toString()
            .match(/[^\/]*$/)[0]), a.lastIndex = b.lastIndex) : P(b) && (e = Object.create(Object.getPrototypeOf(b)), a = Ea(b, e, c, d));
        return a
    }
    ...
    function qc(b) {
        ...
        s((b || "")
            ...
            , function (b) {
                b &&
                    (c = b.replace(/\+/g, "%20")
                        .split("="), d = pc(c[0]), y(d) && (b = y(c[1]) ? pc(c[1]) : !0, rc.call(a, d) ? x(a[d]) ? a[d].push(b) : a[d] = [a[d], b] : a[d] = b))
            });
        return a
    }
    ...
    function Id(b, a) {
        ...
        b = B(b);
        for (d = 0; d < e; ++d)
            if (c = rb[d] + a, H(c = b.attr(c))) return c;
        return null
    }
    ...
    function Nd() {
        ...
        uc || ((ra = M.jQuery) && ra.fn.on ? (B = ra, z(ra.fn, {
            ...
            if (Pb) Pb = !1;
                ...
                for (var d = 0, e; null != (e = a[d]); d++)(c = ra._data(e, "events")) && c.$destroy && ra(e)
    ...
    function Bb(b, a) {
        a && b.setAttribute && s(a.split(" "), function (a) {
            b.setAttribute("class", U((" " + (b.getAttribute("class") || "") + " ")
                .replace(/[\n\t]/g, " ")
                .replace(" " + U(a) + " ", " ")))
        })
    }
        ...
        function g(a) {
            ...
            s(a, function (a) {
                ...
                if (!m.get(a)) {
                    m.put(a, !0);
                    try {
                        H(a) ? (c = ab(a), b = b.concat(g(c.requires))
                            .concat(c._runBlocks), d(c._invokeQueue), d(c._configBlocks)) : G(a) ? b.push(q.invoke(a)) : x(a) ? b.push(q.invoke(a)) : sb(a, "module")
                    } catch (e) {
                        throw x(a) &&
        ...
        function h(b, c) {
            ...
            return {
                ...
                , instantiate: function (a, b, c) {
                    var d = Object.create((x(a) ? a[a.length - 1] : a)
                        .prototype);
                    a = e(a, d, b, c);
                    return P(a) || G(a) ? a : d
                }
        ...
        this.$get = ["$window", "$location", "$rootScope", function (a, c, d) {
            ...
            function f(b) {
                if (b) {
                    ...
                    var c;
                    c = g.yOffset;
                    G(c) ? c = c() : mc(c) ? (c = c[0], c = "fixed" !== a.getComputedStyle(c)
                        .position ? 0 : c.getBoundingClientRect()
                        .bottom) : V(c) || (c = 0);
                    c && (b = b.getBoundingClientRect()
                        .top, a.scrollBy(0, b - c))
                } else a.scrollTo(0, 0)
            }
    ...
    function wc(b, a) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, r, O, p, v, w, L, J, A) {
            ...
            function E(a, b, c, d, e) {
                ...
                s(a, function (b, c) {
                    b.nodeType == pb && b.nodeValue.match(/\S+/) && (a[c] = B(b)
                        .wrap("<span></span>")
                        .parent()[0])
                });
                var f = S(a, b, a, c, d, e);
                ...
                return function (b, c, d) {
                    ...
                    g || (g = (d = d && d[0]) ? "foreignobject" !== ua(d) && d.toString()
                        .match(/SVG/) ? "svg" : "html" : "html");
                    d = "html" !== g ? B(Wb(g, B("<div>")
                            .append(a)
                            .html())) :
                        c ? Ka.clone.call(a) : a;
                    if (h)
            ...
            function ea(a, d, e, f, g, l, k, n, r) {
                ...
                for (var A = -Number.MAX_VALUE
                    ...
                    !K.templateUrl && K.controller && (N = K.controller, J = J || {}, Na("'" + z + "' controller", J[z]
                        , K, aa), J[z] = K);
                    if (N = K.transclude) ca = !0, K.$$tlb || (Na("transclusion", ea, K, aa), ea = K), "element" == N ? (C = !0, A = K.priority, N = aa, aa = e.$$element = B(Y.createComment(" " + z + ": " + e[z] + " ")), d = aa[0], V(g, Ya.call(N, 0), d), Aa = E(N, f, A, l && l.name, {
                        nonTlbTranscludeDirective: ea
                    })) : (N = B(Tb(d))
                        .contents(), aa.empty(), Aa = E(N, f));
                    if (K.template)
                        if (D = !0, Na("template", ka, K, aa), ka = K, N = G(K.template) ? K.template(aa, e) : K.template, N = Sc(N), K.replace) {
                            l = K;
                    ...
                    if (K.templateUrl) D = !0, Na("template", ka, K, aa), ka = K, K.replace && (l = K), v = T(a.splice(M, a.length - M), aa, e, g, ca && Aa, k, n, {
            ...
            Xb.prototype = {
                ...
                , $set: function (a, b, d, e) {
                    ...
                    if ("a" === g && "href" === a || "img" === g && "src" === a) this[a] = b = A(b, "src" === a);
                        ...
                        for (var g = "", h = U(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(h) ? k : /(,)/, h = h.split(k), k = Math.floor(h.length / 2), l = 0; l < k; l++) var q = 2 * l
                            , g = g + A(U(h[q]), !0)
                            , g = g + (" " + U(h[q + 1]));
                        h = U(h[2 * l])
                            .split(/\s/);
    ...
    function Fe() {
        ...
        this.$get = ["$injector", "$window", function (d, e) {
            ...
            return function (g, h, l, k) {
                ...
                if (l) return l = (x(g) ? g[g.length - 1] : g)
                    .prototype, m = Object.create(l), q && f(h, q, m, n || g.name), z(function () {
                        d.invoke(g, m, h, n);
                        return m
                    }, {
                        instance: m
...
, function (c, d, e) {
                ...
                function g(f, g, u, r) {
                    ...
                    r = !!r;
                    for (var v, w, L = 0, J = [], A = [], F = f.length, E = [], s = []; L < F;)
                        if (-1 != (v = f.indexOf(b, L)) && -1 != (w = f.indexOf(a, v + h))) L !== v && E.push(O(f.substring(L
                            , v))), L = f.substring(v + h, w), J.push(L), A.push(c(L, p)), L = w + l, s.push(E.length), E.push("");
                        else {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (c, d, e, f, g) {
            ...
            f.on("click", function (b) {
                if (a.rewriteLinks && !b.ctrlKey && !b.metaKey &&
                    ...
                    P(h) && "[object SVGAnimatedString]" === h.toString() && (h = Ba(h.animVal)
                        .href);
        ...
        this.$get = ["$filter", "$sniffer", function (c, d) {
            ...
            return function (d, f, g) {
                ...
                case "string":
                    ...
                    var J = g ? a : b;
                    v = J[L];
                    v || (":" === d.charAt(0) && ":" === d.charAt(1) && (w = !0, d = d.substring(2)), g = g ? u : q, v = new gc(g), v = (new gb(v, c, g))
                        .parse(d), v.constant ? v.$$watchDelegate =
                ...
                , $watchCollection: function (a, b) {
                    function c(a) {
                        ...
                        if (!D(e)) {
                            if (P(e))
                                if (Sa(e))
                                    for (f !== q && (f = q, p = f.length = 0, k++), a = e.length, p !== a && (k++, f.length = p = a), b = 0; b < a; b++) h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (k++, f[b] = g);
                                else {
                                    f !==
                                        m && (f = m = {}, p = 0, k++);
                                    a = 0;
                                    ...
                                    if (p > a)
                                        for (b in k++, f) e.hasOwnProperty(b) || (p--, delete f[b])
                                } else f !== e && (f = e, k++);
                            return k
                        }
                    }
...
, function (b, a) {
                var c = {}
                    , d = ba((/android (\d+)/.exec(Q((b.navigator || {})
                        .userAgent)) || [])[1])
    ...
    function hb(b, a, c, d) {
        ...
        case "object":
            ...
            if (d) {
                for (g in b)
                    if ("$" !== g.charAt(0) && hb(b[g], a, c)) return !0;
                return !1
            }
            if ("object" === f) {
                for (g in a)
                    if (e = a[g], !G(e) && (f = "$" === g, !hb(f ? b : b[g], e, c, f))) return !1;
                return !0
            }
            return c(b, a);
        case "function":
    ...
    function kd(b) {
        ...
        return function (c, e, f) {
            ...
            s(h, function (a) {
                l = Mf[a];
                g += l ? l(c, b.DATETIME_FORMATS) : a.replace(/(^'|'$)/g, "")
                    .replace(/''/g, "'")
            });
            return g
        }
...
, "</select>"]
    ...
    var Ka = R.prototype = {
            ready: function (b) {
                ...
                var c = !1;
                "complete" === Y.readyState ? setTimeout(a) : (this.on("DOMContentLoaded", a), R(M)
                    .on("load", a))
            }
            , toString: function () {
                var b = [];
        ...
        , Tf = {
            ...
            , search: function (a, c) {
                ...
                case 0:
                    return this.$$search;
                case 1:
                    if (H(a) || V(a)) a = a.toString(), this.$$search = qc(a);
                    else if (P(a)) a = Ea(a, {}), s(a, function (c, e) {
                        null == c && delete a[e]
                    }), this.$$search = a;
    ...
    gb.prototype = {
        ...
        , primary: function () {
            ...
            this.expect("(") ? (a = this.filterChain(), this.consume(")")) : this.expect("[") ? a = this.arrayDeclaration() : this.expect("{") ? a = this.object() : this.peek()
                ...
                .text in lb ? a = lb[this.consume()
                    .text] : this.peek()
                .identifier ? a = this.identifier() : this.peek()
                .constant ? a = this.constant() : this.throwError("not a primary expression"
                    , this.peek());
        ...
        , identifier: function () {
            for (var a = this.consume()
                    .text; this.peek(".") && this.peekAhead(1)
                .identifier && !this.peekAhead(2, "(");) a += this.consume()
                .text + this.consume()
                .text;
        ...
        , filter: function (a) {
            var c = this.$filter(this.consume()
                    .text)
                , d, e;
            if (this.peek(":"))
            ...
            return {
                ...
                , link: function (c, d, e, f, g) {
                    ...
                    c.$watch(e.ngIf, function (c) {
                        ...
                        }) : (k && (k.remove(), k = null), l && (l.$destroy(), l = null), h && (k = tb(h.clone), a.leave(k)
                            .then(function () {
                                k = null
                            }), h = null))
                    })
        ...
        , Ae = ["$compile", function (a) {
            return {
                ...
                , link: function (c, d, e, f) {
                    /SVG/.test(d[0].toString()) ? (d.empty(), a(Fc(f.template, Y)
                        ...
                        function p() {
                            ...
                            for (B = c.length; x < B; x++) {
                                ...
                                for (D = l.length; F < D; F++) d = l[F], (t = r[F + 1]) ? (I = t.element, t.label !== d.label && (m(N, t.label, !1), m(N, d.label, !0), I.text(t.label = d.label)
                                    , I.prop("label", t.label)), t.id !== d.id && I.val(t.id = d.id), I[0].selected !== d.selected && (I.prop("selected", t.selected = d.selected), Qa && I.prop("selected", t.selected))) : ("" === d.id && z ? U = z : (U = w.clone())
                                    .val(d.id)
                                    .prop("selected", d.selected)
                                    .attr("selected", d.selected)
                                    .prop("label", d.label)
                                    .text(d.label), r.push(t = {
                                        element: U
                                        , label: d.label
                                        , id: d.id
                                        , selected: d.selected
    ...
    M.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : (Nd(), Pd(ga), B(Y)
        .ready(function () {
            Jd(Y, sc)
        }))
})(window, document);
